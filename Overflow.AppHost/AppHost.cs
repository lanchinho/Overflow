...
//quebra na hora do deploy pro docker pela cli do aspire
...
var typesenseApiKey = builder.Environment.IsDevelopment()
	...
	: "${TYPESENSE_API_KEY}"; // em dev pega do secrets json, no docker pega da env var.
...
if (!builder.Environment.IsDevelopment())
{
	builder.AddContainer("nginx-proxy", "nginxproxy/nginx-proxy", "1.8")
		...
		.WithBindMount("D:/Projetos Estudos/NetAspire/Overflow/infra/devcerts", "/etc/nginx/certs", true);
}
