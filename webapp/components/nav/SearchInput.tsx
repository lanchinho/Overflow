  ...
  return (
    <div className = "flex flex-col w-full">
      ...
      {showDropdown && results && (
        <div className="absolute top-full z-50 bg-white dark:bg-default-50 shadow-lg border-2 border-default-500 w-[60%]">
          <Listbox
            onAction={onAction}
            items ={results}
          ...
          >
            {question =>(
              <ListboxItem
                ...
                key={question.id}
                startContent={
                  <div className="flex flex-col h-14 min-w-14 justify-center items-center border border-success rounder-md">
